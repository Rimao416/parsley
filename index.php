    ...
    <div class="box">
     <form id="validate_form">
      ...
      <div class="form-group">
       ...
       <input type="text" name="email" id="email" placeholder="Email" required data-parsley-type="email" data-parsley-type-message="Tapez une addresse valide" data-parsley-trigger="keyup" class="form-control" />
      </div>
      <div class="form-group">
